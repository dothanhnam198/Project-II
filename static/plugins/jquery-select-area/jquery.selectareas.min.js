 ...
 */
(function ($) {
    $.imageArea = function (parent, id, value = null) {
        var options = parent.options,
            ...
            area = {
                ...
                template_id: (value && value.template_id) ? value.template_id : '0',
                dbId: (value && value.dbId) ? value.dbId : '0'
            },
            blur = function () {
                area.z = 0;
                refresh("blur");
        ...
        if (options.allowDelete) {
            ...
            $btEdit = bindToEdit($("<div class=\"edit-area\" />"))
                .append(bindToEdit($("<input class=i1 placeholder=title title=title value=" + area.title + "><br>")))
                .append(bindToEdit($("<input class=i2 placeholder=description title=description value=" + area.description + " >")))
                // .append(bindToEdit($("<div class='select-areas-edit-area' onclick=''></div>")))
    ...
    $.imageSelectAreas.prototype.newArea = function (event, value = null) {
        var id = -1;
        this.blurAll();
        ...
        this._areas[id] = $.imageArea(this, id, value);
        if (event) {
    ...
    $.imageSelectAreas.prototype._add = function (options, silent) {
        var id = this.newArea(null, options);
